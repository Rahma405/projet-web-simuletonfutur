...
<section class="container py-5">
  ...
  <?php if (isset($_SESSION['user'])): ?>
    <div class="alert mb-3 d-flex align-items-center gap-2"
         style="background:#d1fadf;border:1px solid #86efac;color:#16a34a;border-radius:10px;padding:10px 16px;font-size:.85rem">
      <i class="fas fa-save"></i>
      <span>Your result will be <strong>automatically saved</strong> to your history when you submit.</span>
    </div>
  <?php endif; ?>
