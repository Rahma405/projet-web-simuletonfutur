  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="nav">
      <ul class="navbar-nav ms-auto align-items-center gap-2">
        ...
        <li class="nav-item"><a class="nav-link" href="recommandation_metiers.php" style="color:#e63946!important"><i class="fas fa-star me-1"></i>Recommandations</a></li>
        <li class="nav-item"><a class="nav-link" href="evolution_carriere.php" style="color:#2a9d8f!important"><i class="fas fa-route me-1"></i>Évolution</a></li>
