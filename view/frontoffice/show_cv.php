...
<div class="container py-5">
  ...
  <div class="card p-4 mb-4">
    ...
    <div class="d-flex gap-2 flex-wrap mb-3">
      <a href="export_pdf.php?id=<?= $cv['id'] ?>" target="_blank" class="btn-hero" style="padding:7px 16px;font-size:.8rem;border-radius:20px;background:linear-gradient(135deg,#e63946,#c1121f)"><i class="fas fa-file-pdf me-1"></i>Exporter PDF</a>
      <a href="recommandation_metiers.php?cv_id=<?= $cv['id'] ?>" class="btn-hero" style="padding:7px 16px;font-size:.8rem;border-radius:20px;background:linear-gradient(135deg,#f4a261,#e07b30)"><i class="fas fa-star me-1"></i>Recommandations</a>
      <a href="evolution_carriere.php?cv_id=<?= $cv['id'] ?>" class="btn-hero" style="padding:7px 16px;font-size:.8rem;border-radius:20px;background:linear-gradient(135deg,#2a9d8f,#264653)"><i class="fas fa-route me-1"></i>Évolution</a>
    </div>
