    ...
    <div class="container">
      ...
      <div class="navbar-collapse" id="nav">
        <ul class="navbar-nav ms-auto align-items-center gap-2">
          <li class="nav-item"><a class="nav-link" href="<?= $baseUrl ?>/index.php"><i
                class="fas fa-home me-1"></i>Accueil</a></li>
          <?php if ($sessionUser): ?>
            <li class="nav-item"><a class="nav-link" href="<?= $baseUrl ?>/view/frontoffice/list_offres.php"><i
                  class="fas fa-briefcase me-1"></i>Offres</a></li>
            <li class="nav-item"><a class="nav-link" href="<?= $baseUrl ?>/view/frontoffice/add_candidature.php"><i
                  class="fas fa-file-alt me-1"></i>Candidature</a></li>
            <li class="nav-item"><a class="nav-link" href="<?= $baseUrl ?>/view/frontoffice/match_offres.php"><i
                  class="fas fa-star me-1" style="color:#f4a261"></i>Matching</a></li>
            <li class="nav-item">
            ...
            <?php endif; ?>
          <?php else: ?>
            <li class="nav-item"><a class="nav-link" href="<?= $baseUrl ?>/view/frontoffice/register.php"><i
                  class="fas fa-user-plus me-1"></i>S'inscrire</a></li>
            <li class="nav-item"><a class="nav-link" href="<?= $baseUrl ?>/view/frontoffice/login.php"><i
                  class="fas fa-sign-in-alt me-1"></i>Connexion</a></li>
            <li class="nav-item"><a class="nav-link admin-link"
