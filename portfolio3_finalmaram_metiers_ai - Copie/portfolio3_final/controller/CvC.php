...
class CvC
{
    ...
    public function listCvsSorted(string $sort = 'id', string $order = 'DESC'): array
    {
        return $this->model->findAllSorted($sort, $order);
    }

    public function searchCvs(string $q, string $sort = 'id', string $order = 'DESC'): array
    {
        return $this->model->search($q, $sort, $order);
    }
    ...
    public function getCvWithAll(int $id): array
    {
        return $this->model->findWithAll($id);
    }
