...
<div class="sidebar">
  ...
  <nav>
    <a href="<?= BASE_URL ?>/index.php"><i class="fas fa-globe"></i> Site public</a>
    <a href="<?= BASE_URL ?>/view/backoffice/list_cvs.php" class="<?= strpos($_SERVER['PHP_SELF'],'cv')!==false?'active':'' ?>">
      <i class="fas fa-file-alt"></i> Liste des CV
    </a>
    <a href="<?= BASE_URL ?>/view/backoffice/add_cv.php"><i class="fas fa-plus-circle"></i> Ajouter un CV</a>
  </nav>
  <div class="sidebar-section">Compétences</div>
  <nav>
    <a href="<?= BASE_URL ?>/view/backoffice/list_competences.php" class="<?= strpos($_SERVER['PHP_SELF'],'competence')!==false?'active':'' ?>">
  ...
  <div class="sidebar-section">Metiers AI</div>
  <nav>
    <a href="../backoffice/dashboard_metiers.php" class="<?= strpos($_SERVER['PHP_SELF'],'dashboard_metiers')!==false?'active':'' ?>">
      <i class="fas fa-chart-line"></i> Dashboard Metiers
    </a>
    <a href="../frontoffice/recommandation_metiers.php"><i class="fas fa-star"></i> Recommandations</a>
    <a href="../frontoffice/evolution_carriere.php"><i class="fas fa-route"></i> Evolution</a>
  </nav>
