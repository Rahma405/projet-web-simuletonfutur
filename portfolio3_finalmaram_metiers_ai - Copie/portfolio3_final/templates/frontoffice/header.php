...
<nav class="navbar navbar-expand-lg">
  <div class="container">
    <a class="navbar-brand" href="<?= BASE_URL ?>/index.php"><i class="fas fa-briefcase me-2"></i><span>Gestion</span> Portfolio</a>
    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#nav">
      <span class="navbar-toggler-icon" style="filter:invert(1)"></span>
    </button>
    <div class="collapse navbar-collapse" id="nav">
      <ul class="navbar-nav ms-auto align-items-center gap-2">
        <li class="nav-item"><a class="nav-link" href="<?= BASE_URL ?>/index.php"><i class="fas fa-home me-1"></i>Accueil</a></li>
        <li class="nav-item"><a class="nav-link" href="<?= BASE_URL ?>/view/frontoffice/list_cvs.php"><i class="fas fa-file-alt me-1"></i>CV</a></li>
        <li class="nav-item"><a class="nav-link" href="<?= BASE_URL ?>/view/frontoffice/recommandation_metiers.php" style="color:#e63946!important"><i class="fas fa-star me-1"></i>Recommandations</a></li>
        <li class="nav-item"><a class="nav-link" href="<?= BASE_URL ?>/view/frontoffice/evolution_carriere.php" style="color:#2a9d8f!important"><i class="fas fa-route me-1"></i>Evolution</a></li>
        <li class="nav-item"><a class="nav-link" href="<?= BASE_URL ?>/view/frontoffice/statistiques.php" style="color:#f4a261!important"><i class="fas fa-chart-pie me-1"></i>Statistiques</a></li>
        <li class="nav-item"><a class="nav-link admin-link" href="<?= BASE_URL ?>/view/backoffice/list_cvs.php"><i class="fas fa-shield-alt me-1"></i>Admin</a></li>
      </ul>
    </div>
  </div>
</nav>
