...
<title><?= htmlspecialchars($pageTitle ?? 'Accueil') ?> — Simule Ton Futur</title>
...
.invalid-feedback{font-size:.8rem;color:#e63946;}
.btn-hero{background:linear-gradient(135deg,var(--red),#c1121f);color:#fff;border:none;border-radius:30px;padding:11px 30px;font-weight:600;font-size:.92rem;box-shadow:0 6px 20px rgba(230,57,70,.3);transition:transform .2s,box-shadow .2s;}
.btn-hero:hover{transform:translateY(-2px);box-shadow:0 10px 28px rgba(230,57,70,.4);color:#fff;}
.btn-outline-hero{border:2px solid #fff;color:#fff;border-radius:30px;padding:10px 28px;font-weight:600;background:transparent;}
...
<nav class="navbar navbar-expand-lg">
  <div class="container">
    <a class="navbar-brand" href="index.php">🚀 <span>Simule</span> Ton Futur</a>
    ...
    <div class="collapse navbar-collapse" id="nav">
      <ul class="navbar-nav ms-auto align-items-center gap-2">
        ...
        <li class="nav-item"><a class="nav-link" href="view/frontoffice/register.php"><i class="fas fa-user-plus me-1"></i>S'inscrire</a></li>
        <li class="nav-item"><a class="nav-link admin-link" href="view/backoffice/list_utilisateurs.php"><i class="fas fa-shield-alt me-1"></i>Admin</a></li>
      </ul>
    </div>
  </div>  
</nav>
