      ...
      <div class="card">
        ...
        <div class="card-body p-4">
          ...
          <form method="POST" novalidate>
            ...
            <div class="text-center mt-3"><a href="<?= $baseUrl ?>/index.php" style="color:#8899bb;font-size:.8rem;text-decoration:none;"><i class="fas fa-arrow-left me-1"></i><?= htmlspecialchars(stf_t('back_home')) ?></a></div>
          </form>
        </div>
      </div>
    </div>
