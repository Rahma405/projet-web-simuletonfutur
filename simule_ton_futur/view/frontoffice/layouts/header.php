    ...
    <div class="navbar-collapse" id="nav">
      <ul class="navbar-nav ms-auto align-items-center gap-2">
        ...
        <?php if ($sessionUser): ?>
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?= $baseUrl ?>/view/frontoffice/messagerie/conversations.php">
              <i class="fas fa-comments me-1"></i>Messagerie
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?= $baseUrl ?>/view/frontoffice/list_cvs.php">
              <i class="fas fa-id-card me-1"></i>Portfolio
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?= $baseUrl ?>/view/frontoffice/list_offres.php">
