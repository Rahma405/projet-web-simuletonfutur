  ...
  <div class="card-body p-4">
    ...
    <div class="table-responsive">
      <table class="table table-hover">
        ...
        <tr>
          <td style="color:#8899bb;font-size:.78rem"><?= $c['id'] ?></td>
          <td style="font-size:.83rem"><?= htmlspecialchars($c['titre_poste']??'-') ?></td>
          <td class="fw-semibold" style="font-size:.86rem"><?= htmlspecialchars($c['nom_competence']) ?></td>
          <td><span class="<?= $b ?>"><?= htmlspecialchars($c['niveau']) ?></span></td>
          <td style="font-size:.83rem"><?= htmlspecialchars($c['categorie']) ?></td>
          <td class="text-center">
            <div class="d-flex gap-1 justify-content-center">
              <a href="edit_competence.php?id=<?= $c['id'] ?>" class="btn btn-sm btn-outline-primary" title="Modifier"><i class="fas fa-edit"></i></a>
              <a href="delete_competence.php?id=<?= $c['id'] ?>" class="btn btn-sm btn-outline-danger btn-delete" title="Supprimer"><i class="fas fa-trash"></i></a>
            </div>
          </td>
        </tr>
        <?php endforeach; ?>
